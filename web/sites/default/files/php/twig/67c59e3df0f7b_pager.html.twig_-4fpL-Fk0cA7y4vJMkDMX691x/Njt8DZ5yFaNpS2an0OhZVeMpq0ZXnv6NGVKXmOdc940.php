...
/* themes/contrib/zeropoint/templates/navigation/pager.html.twig */
class __TwigTemplate_7f97bdf66f726fe932d032694f7f5d8e extends Template
{
    ...
    <ul class=\"pure-paginator pager__items js-pager__items\">
      ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "first", [], "any", false, false, true, 38)) {
                // line 39
                yield "        <li class=\"pure-button pager__item pager__item--first\">
          <a href=\"";
                // line 40
      ...
      ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "previous", [], "any", false, false, true, 47)) {
                // line 48
                yield "        <li class=\"pure-button prev pager__item pager__item--previous\">
          <a href=\"";
                // line 49
      ...
      ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["ellipses"] ?? null), "previous", [], "any", false, false, true, 56)) {
                // line 57
                yield "        <li class=\"pure-button pager__item pager__item--ellipsis\" role=\"presentation\">&hellip;</li>
      ";
            }
            // line 59
            yield "      ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["item"]) {
                // line 61
                yield "        <li class=\"pure-button pager__item";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar((((($context["current"] ?? null) == $context["key"])) ? (" pure-button-active is-active") : ("")));
                yield "\">
          ";
                // line 62
      ...
      ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 80)) {
                // line 81
                yield "        <li class=\"pure-button next pager__item pager__item--next\">
          <a href=\"";
                // line 82
      ...
      ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "last", [], "any", false, false, true, 89)) {
                // line 90
                yield "        <li class=\"pure-button pager__item pager__item--last\">
          <a href=\"";
                // line 91
...
";
    ...
    {
        return "themes/contrib/zeropoint/templates/navigation/pager.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/zeropoint/templates/navigation/pager.html.twig", "/var/www/html/lanister/web/themes/contrib/zeropoint/templates/navigation/pager.html.twig");
    }
