...
/* themes/contrib/zeropoint/templates/views/views-mini-pager.html.twig */
class __TwigTemplate_a5d3992a54ec63fcc8227cb59bc154bd extends Template
{
...
($context["items"] ?? null), "current", [], "any", false, false, true, 28), ));
      ...
      ";
          ...
          <a href=\"";
            ...
            <span aria-hidden=\"true\">";
                // line 36
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, true, true, 36), "text", [], "any", true, true, true, 36)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), "next", [], "any", false, false, true, 36), "text", [], "any", false, false, true, 36), t("››"))) : (t("››"))), "html", null, true);
                yield "</span>
          </a>
        </li>
      ";
...
";
    ...
    {
        return "themes/contrib/zeropoint/templates/views/views-mini-pager.html.twig";
    }
    ...
    {
        return new Source("", "themes/contrib/zeropoint/templates/views/views-mini-pager.html.twig", "/var/www/html/lanister/web/themes/contrib/zeropoint/templates/views/views-mini-pager.html.twig");
    }
